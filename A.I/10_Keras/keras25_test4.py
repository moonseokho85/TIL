...
dense_a =  LSTM(64)(input1)
dense1 = Dense(32)(dense_a) # 차이점은 꼬랑지에 앞에 변수명을 넣어줘야함, 앙상블모델에서 필수적인 요소
dense2 = Dense(16)(dense1) # 계속 인풋과 아웃풋을 정의
dense3 = Dense(8)(dense2)
output1 = Dense(1)(dense3)

input2 = Input(shape=(5, 5)) # 인풋레이어 정의 
dense_b = LSTM(64)(input2)
dense21 = Dense(32)(dense_b) # 차이점은 꼬랑지에 앞에 변수명을 넣어줘야함, 앙상블모델에서 필수적인 요소
dense23 = Dense(16)(dense21)
output2 = Dense(8)(dense23)
...
pred1 = pred1.reshape((1, 5, 5))
pred2 = pred2.reshape((1, 5, 5))
